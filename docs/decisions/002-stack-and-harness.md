...
- Corepack owns pnpm through `packageManager`; `mise.toml` owns non-npm binaries such as Bun, Node, and Vale. ADR-005 owns the detailed authored-script runtime boundary.
